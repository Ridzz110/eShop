...
const front = () => {
    return(
        <div class="flex justify-between relative h-screen w-full overflow-x-hidden">
        ...
        <p class="font-libre text-white lg:text-6xl md:text-5xl text-4xl mx-3 text-end">EXPLORE OUT LUX HEELS<br/> COLLECTION WITH EXCLUSIVE DESIGNS</p>
        </div>
        </div>
    )
}
